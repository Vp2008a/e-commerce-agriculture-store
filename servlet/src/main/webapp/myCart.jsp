     ...
     while(rs.next()){
      %>
			<tr>
				...
				<td><a  href="./incDecQuantityAction?id=<%=rs.getString(1) %>&quantity=inc">
					<i class='fas fa-plus-circle'></i></a> <%=rs.getString("quantity") %> 
						<a href="./incDecQuantityAction?id=<%=rs.getString(1) %>&quantity=dec"><i
