	...
	<table id="customers">
       ...
       %>
		<tr>
			...
			<td><a
				href="cancelOrdersActions.java?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Cancel
					<i class='fas fa-window-close'></i>
			</a></td>
			<td><a
				href="deliveredOrdersActions.java?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>">Delivered
